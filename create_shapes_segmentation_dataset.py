...
def arrange_yolov5_pytorch_dataset_format(annotations, images_records, categories_records, output_dir):
...
def arrange_yolov5_dataset_format(annotations, images_records, categories_records, output_dir, split):
    entries = []
    for image_entry in images_records:
        # im_height = image_entry['height']
        # im_width = image_entry['width']
...
def create_dataset(config_file, shapes_file):
    ...
    for split in splits:
        ...
        # prepare a single label text file.  box format: x_min, y_min, x_max, y_max:
        arrange_yolov5_dataset_format(annotatons_records, images_records, categories_records, output_dir, split)
        ...
        arrange_yolov5_pytorch_dataset_format(annotatons_records, images_records, categories_records, f'{output_dir}/{split}/')
