...
def main():
    ...
    if 'coco_detection_datase' in out_formats_table.keys():
        draw_coco_detection_dataset_example(out_formats_table['coco_detection_datase']['annotations_path'], category_names_table, output_dir)

    if 'yolov5_detection_format' in out_formats_table.keys():
        image_dir = out_formats_table['yolov5_detection_format']['image_dir']
        label_dir = out_formats_table['yolov5_detection_format']['label_dir']
    ...
    if 'single_label_file_format' in out_formats_table.keys():
        label_path=out_formats_table['single_label_file_format']['label_path']
    ...
    if 'yolov5_segmentation_format' in out_formats_table.keys():
        image_dir = out_formats_table['yolov5_segmentation_format']['image_dir']
        label_dir = out_formats_table['yolov5_segmentation_format']['label_dir']
